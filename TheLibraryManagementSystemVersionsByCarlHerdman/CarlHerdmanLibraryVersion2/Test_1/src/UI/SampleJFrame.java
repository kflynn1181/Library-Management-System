...
public class SampleJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        HomePageLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, HomePageLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(HomePageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton14, javax.swing.GroupLayout.PREFERRED_SIZE, 130, Short.MAX_VALUE)
        ...
        RemoveBookLayout.setHorizontalGroup(
            ...
            .addGroup(RemoveBookLayout.createSequentialGroup()
                .addGap(296, 296, 296)
                .addGroup(RemoveBookLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        viewUsersTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "UserId", "FirstName", "LastName", "Age", "Address"
            }
        ));
    ...
    private void ViewUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewUserButtonActionPerformed
        try {
            ...
            while(result.next()){
                ...
                String tbData[]  = {UserId,FirstName,LastName,Age, Address};
    ...
    String firstnameStr = FirstName.getText();  //gets user input for password
    String lastnameStr = LastName.getText(); //gets user input for username
    String ageStr = Age.getText();  //gets user input for password
    String addressStr = Address.getText(); //gets user input for username
        ...
        try {
            ...
            int done =DCC.update("INSERT INTO Users (FirstName, LastName, Age, Address) VALUES ('"+firstnameStr+"', '"+lastnameStr+"', '"+ageStr+"', '"+addressStr+"')");
