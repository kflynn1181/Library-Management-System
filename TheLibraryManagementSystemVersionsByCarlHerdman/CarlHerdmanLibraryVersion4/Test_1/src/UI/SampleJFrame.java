...
public class SampleJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        FirstNameRemove = new javax.swing.JTextField();
        jLabel42 = new javax.swing.JLabel();
        LastNameRemove = new javax.swing.JTextField();
        jLabel43 = new javax.swing.JLabel();
        AgeRemove = new javax.swing.JTextField();
        ...
        HomePageLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, HomePageLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(HomePageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(RemoveBookButton, javax.swing.GroupLayout.PREFERRED_SIZE, 130, Short.MAX_VALUE)
                ...
                .addGroup(RemoveUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(RemoveUserLayout.createSequentialGroup()
                        .addGroup(RemoveUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(AgeRemove, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(RemoveUserLayout.createSequentialGroup()
                        .addGroup(RemoveUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(FirstNameRemove)
                            .addComponent(LastNameRemove)
        ...
        RemoveUserLayout.setVerticalGroup(
            ...
            .addGroup(RemoveUserLayout.createSequentialGroup()
                ...
                .addComponent(jLabel41)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(FirstNameRemove, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel42)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(LastNameRemove, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel43)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(AgeRemove, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel44)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    String usernameStr = UserName.getText();  //gets user input for password
    String emailStr = UserEmail.getText(); //gets user input for username
    String phoneStr = UserPhone.getText();  //gets user input for password
    String addressStr = UserAddress.getText(); //gets user input for username
            ...
            if ("".equals(usernameStr) || " ".equals(usernameStr)) { //error checking, if the password field is empty
                JOptionPane.showMessageDialog(null,"Please enter your FirstName"); //joptionpane to display message, asking user to enter student id
                countcheck = -1;  //countcheck set to minus 1
            }
            
            
            if ("".equals(emailStr) || " ".equals(emailStr)) { //error checking, if the username field is empty
                JOptionPane.showMessageDialog(null,"Please enter your LastName"); //joptionpane to display message, asking user to enter student name
                countcheck = -1;  //countcheck set to minus 1
            }
            
            if ("".equals(phoneStr) || " ".equals(phoneStr)) { //error checking, if the password field is empty
                JOptionPane.showMessageDialog(null,"Please enter your Age"); //joptionpane to display message, asking user to enter student id
                countcheck = -1;  //countcheck set to minus 1
            }         
                        
            if ("".equals(addressStr) || " ".equals(addressStr)) { //error checking, if the password field is empty
                JOptionPane.showMessageDialog(null,"Please enter your Address"); //joptionpane to display message, asking user to enter student id
                countcheck = -1;  //countcheck set to minus 1
            }
            
 
            try {
                 Integer.parseInt(phoneStr);
            }
            catch (NumberFormatException e) {
                 //Not an integer
    ...
    private void SubmitRemoveUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitRemoveUserActionPerformed
            try {                                                 
                // TODO add your handling code here:
                String firstnameStr = FirstNameRemove.getText();  //gets user input for password
                String lastnameStr = LastNameRemove.getText(); //gets user input for username
                String ageStr = AgeRemove.getText();  //gets user input for password
                String addressStr = AddressRemove.getText(); //gets user input for username
                
                int countcheck = 0;                     //countcheck set to 0
                
                
                
                if ("".equals(firstnameStr) || " ".equals(firstnameStr)) { //error checking, if the password field is empty
                    JOptionPane.showMessageDialog(null,"Please enter FirstName"); //joptionpane to display message, asking user to enter student id
                    countcheck = -1;  //countcheck set to minus 1
                }
                
                
                if ("".equals(lastnameStr) || " ".equals(lastnameStr)) { //error checking, if the username field is empty
                    JOptionPane.showMessageDialog(null,"Please enter LastName"); //joptionpane to display message, asking user to enter student name
                    countcheck = -1;  //countcheck set to minus 1
                }
                
                if ("".equals(ageStr) || " ".equals(ageStr)) { //error checking, if the password field is empty
                    JOptionPane.showMessageDialog(null,"Please enter Age"); //joptionpane to display message, asking user to enter student id
                    countcheck = -1;  //countcheck set to minus 1
                }
                
                if ("".equals(addressStr) || " ".equals(addressStr)) { //error checking, if the password field is empty
                    JOptionPane.showMessageDialog(null,"Please enter Address"); //joptionpane to display message, asking user to enter student id
                    countcheck = -1;  //countcheck set to minus 1
                }
                ...
                //ResultSet result=DCC.query("SELECT UserName, Password FROM Admin WHERE Username='"+UserName+"' and Password='"+Password+"'");
                ResultSet result=DCC.query("SELECT FirstName, LastName, Age, Address FROM Users WHERE FirstName='"+firstnameStr+"' and LastName='"+lastnameStr+"' and Age='"+ageInt+"' and Address='"+addressStr+"'");
                if(!result.next()){
                ...
                if (countcheck==4){
                        ...
                        int done =DCC.update("DELETE FROM Users WHERE FirstName='"+firstnameStr+"'");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        // TODO add your handling code here:
        String bookTitleStr = BookTitleIssue.getText();     //gets user input for book title
        ...
        String bookStockStr = BookStockIssue.getText();     //gets user input for book title
        String personNameStr = PersonNameIssue.getText();     //gets user input for book title
        String personAddressStr = PersonAddressIssue.getText();     //gets user input for book title
        String personEmailStr = PersonEmailIssue.getText();     //gets user input for book title
        String personPhoneStr = PersonPhoneIssue.getText();     //gets user input for book title
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        String bookStockStr = BookStockReturn.getText();     //gets user input for book title
        //String personNameStr = PersonNameReturn.getText();     //gets user input for book title
        //String personAddressStr = PersonAddressReturn.getText();     //gets user input for book title
        String personEmailStr = PersonEmailReturn.getText();     //gets user input for book title
        //String personPhoneStr = PersonPhoneReturn.getText();     //gets user input for book title
        int countcheck = 0;                              //countcheck variable set to 0
    ...
    private javax.swing.JTextField AgeRemove;
    ...
    private javax.swing.JTextField FirstNameRemove;
    ...
    private javax.swing.JTextField LastNameRemove;
