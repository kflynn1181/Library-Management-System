...
public class SampleJFrame extends javax.swing.JFrame {
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        String bookStockStr = jTextField33.getText();     //gets user input for book title
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        String bookStockStr = jTextField34.getText();     //gets user input for book title
        ...
        if (countcheck==9 && buyOrRent==0) { //for buy
            //call function here
            DataHandler.ReturnBoughtBook(bookTitleStr, bookAuthourStr, bookPublisherStr, bookGenreStr, bookPriceStr, stockInt, personNameStr, personAddressStr, personEmailStr, personPhoneStr);
            //JOptionPane.showMessageDialog(null, bookTitleStr + " issued successfully to " + personNameStr); //joptionpane to display message, confirming that the user has successfully added a book to the db
        }
        
        if (countcheck==9 && buyOrRent==1) { //for rent
            //call function here
            DataHandler.ReturnRentedBook(bookTitleStr, bookAuthourStr, bookPublisherStr, bookGenreStr, bookPriceStr, stockInt, personNameStr, personAddressStr, personEmailStr, personPhoneStr);
            //JOptionPane.showMessageDialog(null, bookTitleStr + " issued successfully to " + personNameStr); //joptionpane to display message, confirming that the user has successfully added a book to the db
        }
