...
public class SampleJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButton18, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButton24, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Purchased", "Rented" }));

        jLabel48.setText("This book was:");
        ...
        UserTableLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 838, Short.MAX_VALUE)
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String bookStockStr = jTextField31.getText();     //gets user input for book stock
        ...
        if (countcheck==5) {
            //call function here
            DataHandler.AddBook(bookTitleStr, bookAuthourStr, bookPublisherStr, bookGenreStr, bookPriceStr, stockInt);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        String bookStockStr = jTextField32.getText();     //gets user input for book price
        int countcheck = 0;                              //countcheck variable set to 0
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        if ("".equals(personNameStr) || " ".equals(personNameStr)) { //error checking, if the book authour field is empty
            JOptionPane.showMessageDialog(null,"Please enter the name of the person"); //joptionpane to display message, asking user to enter the book authour
            countcheck = -1;  //countcheck set to minus 1
        }
        
        if ("".equals(personAddressStr) || " ".equals(personAddressStr)) { //error checking, if the book publisher field is empty
            JOptionPane.showMessageDialog(null,"Please enter the address of the person"); //joptionpane to display message, asking user to enter the book publisher
            countcheck = -1;  //countcheck set to minus 1
        }

        if ("".equals(personEmailStr) || " ".equals(personEmailStr)) { //error checking, if the book genre field is empty
            JOptionPane.showMessageDialog(null,"Please enter the email of the person"); //joptionpane to display message, asking user to enter the book genre
            countcheck = -1;  //countcheck set to minus 1
        }
        
        if ("".equals(personPhoneStr) || " ".equals(personPhoneStr)) { //error checking, if the price field is empty
            JOptionPane.showMessageDialog(null,"Please enter the phone number of the person"); //joptionpane to display message, asking user to enter the book price
            countcheck = -1;  //countcheck set to minus 1
        }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(jPanel12);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        // TODO add your handling code here:
        String bookTitleStr = jTextField22.getText();     //gets user input for book title
        String bookAuthourStr = jTextField23.getText();   //gets user input for book authour
        String bookPublisherStr = jTextField24.getText(); //gets user input for book publisher
        String bookGenreStr = jTextField25.getText();     //gets user input for book genre
        String bookPriceStr = jTextField26.getText();     //gets user input for book price
        String personNameStr = jTextField27.getText();     //gets user input for book title
        String personAddressStr = jTextField28.getText();     //gets user input for book title
        String personEmailStr = jTextField29.getText();     //gets user input for book title
        String personPhoneStr = jTextField30.getText();     //gets user input for book title
        int countcheck = 0;                              //countcheck variable set to 0
        int buyOrRent = jComboBox2.getSelectedIndex();
        //System.out.println("Selected: " + buyOrRent);
        //if (buyOrRent==1) {
            //System.out.println("Selected: " + buyOrRent);
        //}
        ...
        if (countcheck==9 && buyOrRent==0) { //for buy
            //call function here
            DataHandler.ReturnBoughtBook(bookTitleStr, bookAuthourStr, bookPublisherStr, bookGenreStr, bookPriceStr, personNameStr, personAddressStr, personEmailStr, personPhoneStr);
            //JOptionPane.showMessageDialog(null, bookTitleStr + " issued successfully to " + personNameStr); //joptionpane to display message, confirming that the user has successfully added a book to the db
        }
        
        if (countcheck==9 && buyOrRent==1) { //for rent
            //call function here
            DataHandler.ReturnRentedBook(bookTitleStr, bookAuthourStr, bookPublisherStr, bookGenreStr, bookPriceStr, personNameStr, personAddressStr, personEmailStr, personPhoneStr);
            //JOptionPane.showMessageDialog(null, bookTitleStr + " issued successfully to " + personNameStr); //joptionpane to display message, confirming that the user has successfully added a book to the db
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        String DisplayUsers = "Users";
        viewUsersTable.setModel(tableModel);
        tableModel.setDataVector(DataHandler.getRows(DisplayUsers), DataHandler.getTitles(DisplayUsers));
            ...
            if (countcheck==4){
                ...
                try {
                    ...
                    Logger.getLogger(SampleJFrame.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            //call function here
            DataHandler.AddUser(userNameStr, userAddressStr, userEmailStr, userPhoneStr);
            JOptionPane.showMessageDialog(null,"User added successfully!"); //joptionpane to display message, confirming that the user has successfully added a book to the db
            }
    ...
    private void SubmitRemoveUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitRemoveUserActionPerformed
            // TODO add your handling code here:
            String userNameStr = UserNameFieldRemove.getText();  //gets user input for password
            String userAddressStr = UserAddressFieldRemove.getText(); //gets user input for username
            String userEmailStr = UserEmailFieldRemove.getText();  //gets user input for password
            String userPhoneStr = UserPhoneFieldRemove.getText(); //gets user input for username
            ...
            if (countcheck==4){
            DataHandler.RemoveUser(userNameStr, userAddressStr, userEmailStr, userPhoneStr);
