...
public class SampleJFrame extends javax.swing.JFrame {
    ...
    private void ViewBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(ListOfBooks);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void LogoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        LoginNameTextField.setText(""); //sets username text field to empty
        LoginPasswordTextField.setText("");  //gets password text field to empty
    ...
    private void AddBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(AddABook);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void RemoveBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(RemoveABook);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void RemoveABookSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveABookSubmitButtonActionPerformed
        ...
        String bookStockStr = RemoveABookBookStockTextField.getText();     //gets user input for book price
        int countcheck = 0;                              //countcheck variable set to 0
    ...
    private void IssueBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IssueBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(IssueABook);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void IssueABookSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IssueABookSubmitButtonActionPerformed
        ...
        String bookStockStr = IssueABookBookStockTextField.getText();     //gets user input for book title
        String personNameStr = IssueABookPersonNameTextField.getText();     //gets user input for book title
        String personAddressStr = IssueABookPersonAddressTextField.getText();     //gets user input for book title
        String personEmailStr = IssueABookPersonEmailTextField.getText();     //gets user input for book title
        String personPhoneStr = IssueABookPersonPhoneTextField.getText();     //gets user input for book title
        int countcheck = 0;                              //countcheck variable set to 0
        int buyOrRent = IssueABookBuyOrRentBox.getSelectedIndex();
    ...
    private void IssueABookIssuedBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IssueABookIssuedBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(IssuedBooks);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void RemoveUsersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveUsersButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(RemoveAUser);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void ReturnBooksButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReturnBooksButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(ReturnABook);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void ReturnABookSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReturnABookSubmitButtonActionPerformed
        ...
        String bookStockStr = ReturnABookBookStockTextField.getText();     //gets user input for book title
        String personNameStr = ReturnABookPersonNameTextField.getText();     //gets user input for book title
        String personAddressStr = ReturnABookPersonAddressTextField.getText();     //gets user input for book title
        String personEmailStr = ReturnABookPersonEmailTextField.getText();     //gets user input for book title
        String personPhoneStr = ReturnABookPersonPhoneTextField.getText();     //gets user input for book title
        int countcheck = 0;                              //countcheck variable set to 0
        int buyOrRent = ReturnABookBuyOrRentBox.getSelectedIndex();
        //System.out.println("Selected: " + buyOrRent);
        //if (buyOrRent==1) {
            //System.out.println("Selected: " + buyOrRent);
        //}
    ...
    private void ViewUsersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewUsersButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(ListOfUsers);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
    ...
    private void AddAUserSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddAUserSubmitButtonActionPerformed
        ...
        String userNameStr = AddAUserUserNameTextField.getText();  //gets user input for password
        String userAddressStr = AddAUserUserAddressTextField.getText(); //gets user input for username
        String userEmailStr = AddAUserUserEmailTextField.getText();  //gets user input for password
        String userPhoneStr = AddAUserUserPhoneTextField.getText(); //gets user input for username
    ...
    private void RemoveAUserSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveAUserSubmitButtonActionPerformed
            // TODO add your handling code here:
            String userNameStr = RemoveAUserUserNameTextField.getText();  //gets user input for password
            String userAddressStr = RemoveAUserUserAddressTextField.getText(); //gets user input for username
            String userEmailStr = RemoveAUserUserEmailTextField.getText();  //gets user input for password
            String userPhoneStr = RemoveAUserUserPhoneTextField.getText(); //gets user input for username
    ...
    private void AddUsersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddUsersButtonActionPerformed
        ...
        jPanel3.repaint();
        jPanel3.revalidate();
        jPanel3.add(AddAUser);                              //selects a jpanel, or question, at random
        jPanel3.repaint();
        jPanel3.revalidate();
